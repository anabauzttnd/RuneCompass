...
#[derive(Debug)]
pub struct RuneCompassProcessor {
    verbose: bool,
    processed_count: usize,
}

impl RuneCompassProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting RuneCompass processing");
    
    let mut processor = RuneCompassProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = RuneCompassProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = RuneCompassProcessor::new(false);
